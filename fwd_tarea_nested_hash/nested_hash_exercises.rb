def find_language_information(languages, language_name)
  ...
  hashLang={
   ...
   find_language_information(hashLang, :ruby)
...
hashL={
 ...
 add_information_about_language(hashL,:ruby,:is_beautiful?, true)
...
value_to_add = { is_beautiful?: false, initial_release: 'May 23, 1995' }
 ...
 add_language(hash3,:Java,value_to_add)
...
hash4={
 ...
 delete_information_about_language(hash4, :ruby, :is_beautiful?)
...
hash6={
  ...
  python: { is_beautiful?: false, initial_release: 'Feb 20, 1991' }
   ...
   find_beautiful_languages(hash6)
...
hash7={
  ...
  p find_language_facts(hash7, :ruby,0)